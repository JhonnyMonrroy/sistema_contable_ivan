...
<html lang="es-ES">
  ...
  <body>
  	<div class="container" data-ng-app="cuentascobApp" data-ng-controller="cuentascobCtrl">
  		<h1>Cuentas por Cobrar</h1>
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editarCuentascobModal" data-ng-click="nuevoCuentascob()">Nuevo registro</button>
		<p/>
		<table class="table">
			<tr>
		<th>ID</th><th>TIPO</th><th>FECHA</th><th>TIPO DE CAMBIO</th><th>MEDIDA</th><th>MODELO</th><th>DESCRIPCION</th><th>PRECIO 1</th><th>PRECIO 2</th><th>PRECIO 3</th><th></th>
			</tr>
